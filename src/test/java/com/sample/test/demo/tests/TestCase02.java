...
import dataproviders.DataProviderTestCase02;
...
public class TestCase02 extends TestBase {
    ...
    @Test(dataProviderClass = DataProviderTestCase02.class, dataProvider = "DPTestCase02Details")
    public void AssertTest02(String pizzaType, String pizzaTopping1, Integer pizzaQuantity, BigDecimal pizzaCost, String userName, String userEmail, String userPhone) {
